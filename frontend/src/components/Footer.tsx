  ...
  return (
    <div className="h-auto bg-theme-dark bottom-0 p-1">
      <div className="flex flex-col items-center justify-center md:flex-row m-10">
        <div className="h-56 w-full md:w-1/2 p-5 flex flex-col items-center text-center gap-3 rounded-3xl bg-white m-3">
      ...
      <div className="p-10">
        ...
        <p className="text-white pb-5">© 2024 Nestup.space All rights reserved.</p>
      </div>
