...
// Align with ModelInputParameterSchema in ModelBuilderForm.tsx
...
interface ModelInputParameterItemProps {
  index: number;
  remove: UseFieldArrayRemove;
  // control, register, errors, watch are available via useFormContext
}
...
export default function ModelInputParameterItem({ index, remove }: ModelInputParameterItemProps) {
  ...
  }, [watchedInputType, index, setValue, getValues]); // Added getValues
