...
import type { NestResult } from '../types/visualiser.types';
 ...
 */
function generateGCodeForSheet(planks: GCodePlank[], _sheetName: string): string {
  const gcode: string[] = [];
