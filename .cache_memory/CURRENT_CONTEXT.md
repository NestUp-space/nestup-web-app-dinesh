...
1. Upon user approval, write new LTM entries (project-specific and generic) and/or update the `.mbk` file.
2. Propose updates to the relevant `INDEX.md` file(s) (project-specific and/or generic) to link to new entries.
3. Upon user approval, update the `INDEX.md` file(s).
4. Mark sub-task as complete in `CURRENT_TODO.md`.
5. Update this `CURRENT_CONTEXT.md` with completion status and pointer to the next sub-task.
